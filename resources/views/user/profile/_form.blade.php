...
<div class="row">
    <div class="col-md-12">
        <h3>{{ trans('user/profile.account_info') }}</h3>
        <hr>
    </div>
    <div class="col-md-6">
        <div class="form-group {{{ $errors->has('fullname') ? 'has-error' : '' }}}">
            {{ Form::label('fullname', trans('user/profile.fullname'), array('class' => 'control-label')) }}
            <div class="controls">
                {{ Form::text('fullname', $user->fullname, array('class' => 'form-control', 'disabled' => 'disabled')) }}
        ...
        <div class="form-group">
            ...
            <div class="fileupload fileupload-new" data-provides="fileupload">
                <div class="fileupload-new thumbnail" style="width: 150px; height: 150px;">
                    <img src="{{ $user->profile->image->url('medium') }}">
                </div>
...
@section('styles')
<!-- Date Picker -->
{{ HTML::style(Theme::asset('plugins/bootstrap-datepicker/css/datepicker.css')) }}
<!-- File Input -->
...
@section('scripts')
<!-- Date Picker -->
{{ HTML::script(Theme::asset('plugins/bootstrap-datepicker/js/bootstrap-datepicker.js')) }}
<!-- File Input -->
