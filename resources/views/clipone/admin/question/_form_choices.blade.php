    ...
    <div class="panel-body">
        ...
        <table class="table table-hover">
            ...
            <tr>
                ...
                <td>
                    <a href="{{ route('admin.questions.choices.edit', array($question, $choice)) }}" class="btn btn-xs btn-teal tooltips" data-placement="top" data-original-title="Edit"><i class="fa fa-edit"></i></a>
