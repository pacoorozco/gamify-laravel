...
{{ Form::model($choice, array(
            'route' => array('admin.questions.choice.update', $question->id, $choice->id),
            'method' => 'put',
            'files' => true
            )) }}
@else
{{ Form::open(array(
            'route' => array('admin.questions.choice.store', $question->id),
            'method' => 'post',
            'files' => true
            )) }}
@endif
...
<div class="row">
    <div class="col-xs-12">
        ...
        <div class="form-group">
            <div class="controls">
                <a href="{{ route('admin.questions.edit', $question->id) }}" class="btn btn-primary">{{ trans('button.back') }}</a>
