<div class="main-navigation navbar-collapse collapse">
    ...
    <ul class="main-navigation-menu">
        ...
        <li {{ (Request::is('admin/roles*') ? ' class="active"' : '') }}>
            <a href="{{ route('admin.roles.index') }}"><i class="fa fa-flag-checkered"></i>
                <span class="title"> {{ trans('admin/site.roles') }} </span>
            </a>
        </li>
        ...
        <li></li>
        <li>
            <a href="{{ route('home') }}"><i class="fa fa-reply"></i>
                <span class="title"> {{ trans('admin/site.play_area') }} </span>
            </a>
        </li>
        <li>
        <li>
