{{ Theme::js('plugins/select2/select2.min.js')) }}
{{ Theme::js('plugins/DataTables/media/js/jquery.dataTables.min.js')) }}
{{ Theme::js('plugins/DataTables/media/js/DT_bootstrap.js')) }}
