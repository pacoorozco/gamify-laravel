    ...
    <body>
            ...
            <div class="container">
                ...
                <div class="navbar-tools">
                    ...
                    <ul class="nav navbar-right">
                        ...
                        {{-- @include('partials.notification_dd') --}}
        ...
        <div class="footer clearfix">
            <div class="footer-inner">
                {{ date("Y"); }} &copy; {{ HTML::link('http://pacoorozco.info', 'Paco Orozco', array('rel' => 'nofollow')) }} - Powered by {{ HTML::link('https://github.com/pacoorozco/laravel-gamify', 'gamify v3', array('rel' => 'nofollow')) }}
            </div>
