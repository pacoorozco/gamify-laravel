<div class="box box-primary">
    ...
    <div class="box-body">
        ...
        <table class="table table-condensed table-hover">
            <thead>
            <tr>
                <th colspan="2">{{ __('user/profile.contact_info') }}</th>
            </tr>
            </thead>
            <tbody>
            <tr>
                <td>{{ __('user/profile.url') }}:</td>
                <td>
        ...
        <table class="table table-condensed table-hover">
            ...
            <tr>
                <td>{{ __('user/profile.last_logged') }}:</td>
